...
<div id="right-panel" class="right-panel">
    ...
    <div class="content">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form class="form-horizontal form-label-left input_mask" action="XL_themma.php" method="POST"
                              enctype="multipart/form-data" accept-charset="utf-8">
                            <div class="form-group">
                                <labelclass
                                =" form-control-ldabel">Tên món ăn</label><input type="text" name="ma_ten"
                                                                                 placeholder="Nhập tên món ăn"
                                                                                 class="form-control"></div>
                            <div class="form-group"><label class=" form-control-label">KCAL</label><input type="text"
                                                                                                          name="ma_kcal"
                            ...
                            <div class="row form-group">
                                <div class="col col-md-6"><label for="select" class=" form-control-label">Vùng
                                        miền</label></div>

                                <div class="col-12 col-md-9">
                                    <select class="select2-vmid  form-control " multiple="multiple" name='vm_id[]'
                                            id="vm_id"/>
                                    <?php
                                    include('connect.php');
                                ...
                                <button type="button" class="btn btn-info btn-lg vung_mien" data-toggle="modal"
                                        data-target="#myModal">+
                                </button>
                                </td></tr>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-6"><label for="select" class=" form-control-label">Mùa</label>
                                </div>

                                <div class="col-12 col-md-9">
                                    <select class="select2-muaid  form-control " multiple="multiple" name='mua_id[]'
                                            id="mua_id"/>
                                    <?php
                                    include('connect.php');
                                    $sql = "SELECT * FROM mua ";
                                ...
                                <button type="button" class="btn btn-info btn-lg mua" data-toggle="modal"
                            ...
                            <div class="row form-group">
                                <div class="col col-md-6"><label for="select" class=" form-control-label">Độ tuổi phù
                                        hợp</label></div>
                                <div class="col-12 col-md-9">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-6"><label for="select" class=" form-control-label">Sức
                                        khỏe</label></div>

                                <div class="col-12 col-md-9">
                                    <select class="select2-skid  form-control " multiple="multiple" name='sk_id[]'
                                            id="sk_id"/>
                                    <?php
                                    include('connect.php');
                                ...
                                <button type="button" class="btn btn-info btn-lg suc_khoe" data-toggle="modal"
                                        data-target="#myModal2">+
                                </button>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-6"><label for="select" class=" form-control-label">Thời
                                        điểm</label></div>

                                <div class="col-12 col-md-9">
                                    <select class="select2-tdid  form-control " multiple="multiple" name='td_id[]'
                                            id="td_id"/>
                                    <?php
                                    include('connect.php');
                            ...
                            <div class="form-group"><label class=" form-control-label">Hình ảnh</label><input
                                        type="file" name="ma_hinhanh" multiple accept="image/*" class="form-control">
                            </div>
                    </div>
        ...
        <form class="form-horizontal form-label-left input_mask" action="XL_themvm.php" method="POST"
              enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group"><label class=" form-control-label">Vùng miền</label><input
                                        type="text" name="vm_ten" placeholder="Nhập tên vùng miền mới"
                                        class="form-control"></div>
                        </div>
        ...
        <form class="form-horizontal form-label-left input_mask" action="XL_themmua.php" method="POST"
              enctype="multipart/form-data" accept-charset="utf-8">
            <div class="modal fade" id="myModal1" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label class=" form-control-label">Mùa</label>
                                <input type="text"
                                       name="mua_ten"
                                       placeholder="Nhập mùa mới"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="modal-footer">
        ...
        <form class="form-horizontal form-label-left input_mask" action="XL_themsk.php" method="POST"
              enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group"><label class=" form-control-label">Loại sức khỏe</label><input
                                        type="text" name="sk_loaisk" placeholder="Nhập loại mới" class="form-control">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" name="submit" class="btn btn-primary btn-sm">Lưu</button>
        ...
        <form class="form-horizontal form-label-left input_mask" action="XL_themtd.php" method="POST"
              enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group"><label class=" form-control-label">Thời điểm</label><input
                                        type="text" name="td_ten" placeholder="Nhập thời điểm mới" class="form-control">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" name="submit" class="btn btn-primary btn-sm">Lưu</button>
